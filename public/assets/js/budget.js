...
function calculateBudget(){
    ...
    if (allocated > budget) {
        ...
        $(".adjust-text").html('<span class="text-danger">Bạn đã phân bổ nhiều hơn ngân sách trong một tháng.</span>');
    }else{
        $("#distribute").removeClass("exceeded");
        $(".adjust-text").text("Phân phối ngân sách của bạn cho các hạng mục");
    }
}
